...
export default function AddUsu(props) {
    ...
    return (<>
        ...
        <div className="mb-2">
            ...
            <input onChange={(e) => setUser({ ...user, senha: encrypt(e.target.value) })} autoComplete="password" type="password" className={"form-control form-control-sm " + (validatelist.includes(("senha")) ? "border-danger" : "")} id="senha" />
        </div>
        <div className="mb-2">
